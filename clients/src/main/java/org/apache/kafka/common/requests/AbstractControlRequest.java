...
public abstract class AbstractControlRequest extends AbstractRequest {
    ...
    public static abstract class Builder<T extends AbstractRequest> extends AbstractRequest.Builder<T> { // controllerEpoch和brokerEpoch这两个Epoch字段用于隔离Zombie Controller和Zombie Broker以保证集群的一致性
